...
public class CounterAttackActionTest {
    ...
    public void wishColor() {
        ...
        CounterAttackAction counterattack = new CounterAttackAction(initiator, Color.BLUE, discardPile);
        List<Chat> chat = counterattack.perform();
        ...
        assertEquals("special:counterattack", chatIcon);
    }
