...
public class CommunismEventTest {
    ...
    public void performEventTest() {
        ...
        player2.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.TWO, false, 0));
        player2.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.THREE, false, 1));
        this.listOfPlayers.add(player2);

        Player player3 = new Player();
        player3.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.FOUR, false, 0));
        player3.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.FIVE, false, 1));
        player3.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.SIX, false, 2));
        this.listOfPlayers.add(player3);

        Player player4 = new Player();
        player4.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.SEVEN, false, 0));
        player4.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.EIGHT, false, 1));
        player4.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.NINE, false, 2));
        player4.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.ONE, false, 3));
        player4.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.TWO, false, 4));
        player4.pushCardToHand(new Card(Color.GREEN, Type.NUMBER, Value.THREE, false, 5));
