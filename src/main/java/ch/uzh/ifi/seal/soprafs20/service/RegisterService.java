...
public class RegisterService {
    ...
    public void joinLobby(String identity, RegisterDTO register) throws InterruptedException {
        ...
        webSocketService.sendChatPlayerMessage(lobbyId, "joined the lobby.", player.getUsername());
    }
